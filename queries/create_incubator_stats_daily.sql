CREATE TABLE IF NOT EXISTS incubator_stats_daily (
    ...
    avg_monthly_active_editors_3months INT COMMENT 'Average number of active editors for the last 3 months, for the project.',
    avg_monthly_active_editors_6months INT COMMENT 'Average number of active editors for the last 6 months, for the project.'
)
ENGINE=InnoDB
